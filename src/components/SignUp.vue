...
<template>
    ...
    <div class=" mx-auto bg-gray-800 max-w-2xl rounded-2xl p-14 mt-8">
        ...
        <input v-model="username" class="bg-transparent w-full mt-1 p-3 border border-green-500 rounded-lg focus:text-black text-slate-100 focus:bg-blue-50 focus:placeholder-green-600 placeholder-slate-400" placeholder="Enter your username"/>
        ...
        <input v-model="password" type="password" id="password" :class="`${passNotSame ? 'bg-red-400' : 'bg-transparent'} w-full mt-1 p-3 border border-green-500 rounded-lg focus:text-black text-slate-100 focus:bg-blue-50 focus:placeholder-green-600 bg-transparent placeholder-slate-400`" placeholder="Enter your password"/>
    
        <label for="password" class="flex text-slate-100 mt-5">Password again</label>
        <input v-model="secPassword" type="password" id="password2" :class="`${passNotSame ? 'bg-red-400' : 'bg-transparent'} w-full mt-1 p-3 border border-green-500 rounded-lg focus:text-black text-slate-100 focus:bg-blue-50 focus:placeholder-green-600 bg-transparent placeholder-slate-400`" placeholder="One more time"/>
    
        <span v-if="passNotSame" class="text-red-500 text-lg">Passwords aren't same</span>
