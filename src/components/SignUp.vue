...
<template>
    <div class="max-w-screen w-full text-center">
        <button class="text-white bg-green-600 w-32 h-12 rounded-lg mt-10 font-bold text-lg" @click="emits('goLogin')">Go Login</button>
    </div>
    <div class=" mx-auto bg-gray-800 max-w-2xl rounded-2xl p-16 mt-12">
